...
CGelSightMarkerMotion::CGelSightMarkerMotion()
{
	...
	cv::namedWindow("LocalMaskImg", 1);
	cv::namedWindow("DebugOutFlowImg",1);
	cv::namedWindow("MarkerMotionContactMap",1);

#endif
	cv::namedWindow("MarkerMotionFlow",1);
...
void CGelSightMarkerMotion::DetectBlackMarkerPosition(const cv::Mat inRawColorImg, const bool bInitImg, cv::Mat &outMarkerMaskImg)
{
	...
	//=================================================================================================================================
	int local_maker_pos[MARKER_MAXNUM_HEIGHT][MARKERMOTION_MARKERNUM_INCOL][4];
	int local_maker_num_inrow[MARKER_MAXNUM_HEIGHT];
